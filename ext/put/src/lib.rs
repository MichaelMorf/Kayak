...
pub fn init(db: Rc<dyn DB>) -> u64 {
...

    {
        ...
        let table: u64 = *table.get(0).unwrap() as u64 +
                        (*table.get(1).unwrap() as u64) * 2u64.pow(8) +
                        (*table.get(2).unwrap() as u64) * 2u64.pow(16) +
                        (*table.get(3).unwrap() as u64) * 2u64.pow(24) +
                        (*table.get(4).unwrap() as u64) * 2u64.pow(32) +
                        (*table.get(5).unwrap() as u64) * 2u64.pow(40) +
                        (*table.get(6).unwrap() as u64) * 2u64.pow(48) +
                        (*table.get(7).unwrap() as u64) * 2u64.pow(56);
