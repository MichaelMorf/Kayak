    ...
    M: Sized + Send,
{
    ...
    #[inline]
    pub fn new<B: BatchIterator<Header = T, Metadata = M>>(batch: &mut B) -> PayloadEnumerator<T, M> {
    ...
    #[inline]
    pub fn next<B: BatchIterator<Header = T, Metadata = M>>(&self, batch: &mut B) -> Option<ParsedDescriptor<T, M>> {
